Spree::OrderUpdater.class_eval do
  def update_adjustment_total
    ...
    order_promo_incl_tax = adjustments.promotion.eligible.sum(:amount)
    # fix tax on promo_total
    if order_promo_incl_tax > 0
      pre_tax_on_promo_amount = order_promo_incl_tax / (1.21)
      tax_promo_amount = order_promo_incl_tax - pre_tax_on_promo_amount
