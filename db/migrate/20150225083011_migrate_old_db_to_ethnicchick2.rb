class MigrateOldDbToEthnicchick2 < ActiveRecord::Migration
  ...
  #     t.add_index ["tax_category_id"], name: "index_spree_line_items_on_tax_category_id", using: :btree
  #   end
  #
  #   # Mail methods
  #
  ...
  #   # Product Properties
  #
  #   add_column :product_properties, :position, default: 0
  ...
  #     t.rename_column "permalink", "slug"
  #
  ...
  #
  #   change table "spree_shipping_methods", force: :cascade do |t|
  #     t.remove  "zone_id"
